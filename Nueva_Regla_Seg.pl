...
aplicar_regla_1(_, 82, Posibilidades, FilaUnicos, ColumnaUnicos, CuadradoUnicos, DefinitivasPosibilidades) :-
    ...
    DefinitivasPosibilidades = NuevaPosibilidades,
...
aplicar_regla_1(Sudoku, Indice_Regla1, Posibilidades, FilaUnicos, ColumnaUnicos, CuadradoUnicos, DefinitivasPosibilidades) :-
    ...
    writeln("Unico Columna: "), writeln(UnicoColumna),
    writeln("Unico Cuadrado: "), writeln(UnicoCuadrado),
    ...
    aplicar_regla_1(Sudoku, NuevoIndice, Posibilidades, NuevaFilaUnicos, NuevaColumnaUnicos, NuevaCuadradoUnicos, DefinitivasPosibilidades).
...
resolver_regla_1(Sudoku, NuevoSudoku) :-
    ...
    ajuste_de_posibilidades(Posibilidades, PosibilidadesAjustadas),
    writeln("Posibilidades: "), writeln(Posibilidades),
    aplicar_regla_1(Sudoku, 1, PosibilidadesAjustadas, [], [],[], DefinitivasPosibilidades),
    ajuste_de_posibilidades(DefinitivasPosibilidades, Fin),
